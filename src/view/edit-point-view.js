...
const renderDestinationPictures = (pictures) => {
  ...
  result = `<div class="event__photos-container">
...
const renderOffers = (allOffers, offersIds) => {
  let result = '';
  for (const offer of allOffers) {
    const checked = offersIds.includes(offer.id) ? 'checked' : '';
...
const createTemplate = (point, destinations, offers) => {
  ...
  const allPointTypeOffers = offers.find((offer) => offer.type === type).offers;
  return (
        ...
        <section class="event__details">
          <section class="event__section  event__section--offers">
            ...
            <div class="event__available-offers">
              ${renderOffers(allPointTypeOffers, offerIds)}
            </div>
          </section>
